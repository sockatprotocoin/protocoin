...
class VarIntTest {
    ...
    void oneByteValueTest() {
        ...
        var varInt = new VarInt(BigInteger.valueOf(64));
    ...
    void twoByteValueTest() {
        ...
        var varInt = new VarInt(BigInteger.valueOf(200));
        var bytes = varInt.getBytes();
        var bytesString = Converter.byteArrayToHexString(bytes);
    ...
    void threeByteValueTest() {
        ...
        var varInt = new VarInt(BigInteger.valueOf(16_000_000));
        var bytes = varInt.getBytes();
        var bytesString = Converter.byteArrayToHexString(bytes);
    ...
    void fourByteValueTest() {
        ...
        var varInt = new VarInt(BigInteger.valueOf(305_419_896));
        var bytes = varInt.getBytes();
        var bytesString = Converter.byteArrayToHexString(bytes);
